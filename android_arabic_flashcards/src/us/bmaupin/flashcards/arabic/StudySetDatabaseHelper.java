...
public class StudySetDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String TAG = "StudySetDatabaseHelper";
    ...
    private static final String DEFAULT_STUDY_SET_TABLE_NAME = "profile1";
    ...
    void setStudySetTableName(String profileTableName) {
        if (profileTableName.equals("")) {
            this.profileTableName = DEFAULT_STUDY_SET_TABLE_NAME;
        } else {
            this.profileTableName = profileTableName;
        }
        verifyStudySetTableExists(this.profileTableName);
    }
    
    public String getStudySetTableName() {
        return profileTableName;
    }
    
    private void verifyStudySetTableExists(String profileTableName) {
